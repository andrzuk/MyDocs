...
class Sites_Model extends Model
{
	...
	public function GetAll()
	{
		...
		try
		{
			$query = 	'SELECT ' . $this->table_name . '.id, main_page, system_page, category_id, title, contents, description,' .
	...
	public function Preview($id)
	{
		...
		try
		{
			$query = 	'SELECT title, contents, description, category_id, user_login, archives.modified' .
						' FROM archives' .
